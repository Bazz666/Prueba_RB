...
photos = build_web_page(request('https://api.nasa.gov/mars-photos/api/v1/rovers/curiosity/photos?sol=100')["photos"]) # manipulando el link podemos acotar la cantidad de fotografias cambiando "photos?sol=1000" cambiando el 1000 por el numero de imagenes deseadas
